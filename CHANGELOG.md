...
* Initial release
* `ImageCropper` widget with Apple Photos-style crop experience
* Spring physics animations for smooth, natural interactions
...
* HDR/HEIF image normalization via `flutter_image_compress`
* Configurable theming via `CropperThemeData`
